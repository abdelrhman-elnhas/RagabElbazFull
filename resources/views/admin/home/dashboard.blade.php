    ...
    <div class="row">
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-darked card-img-holder text-white">
                <div class="card-body">
                    <img src="{{ env('APP_URL') . asset('admin_files') }}/images/dashboard/circle.svg"
                        class="card-img-absolute" alt="circle-image">
                    <h4 class="font-weight-normal mb-3"> عدد الطلاب <i
        ...
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-darked card-img-holder text-white">
                <div class="card-body">
                    <img src="{{ env('APP_URL') . asset('admin_files') }}/images/dashboard/circle.svg"
                        class="card-img-absolute" alt="circle-image">
                    <h4 class="font-weight-normal mb-3"> عدد الامتحانات <i
        ...
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-darked card-img-holder text-white">
                <div class="card-body">
                    <img src="{{ env('APP_URL') . asset('admin_files') }}/images/dashboard/circle.svg"
                        class="card-img-absolute" alt="circle-image">
                    <h4 class="font-weight-normal mb-3"> عدد الدروس <i
                            class="mdi mdi-note-multiple-outline mdi-24px float-right"></i>
                    </h4>
...
@endsection
@push('scripts')
    <script src="{{ env('APP_URL') . asset('admin_files') }}/js/chart.min.js"></script>
    <script src="{{ env('APP_URL') . asset('admin_files') }}/js/chart.js"></script>
    <script src="{{ env('APP_URL') . asset('admin_files') }}/js/dashboard.js"></script>
    <script src="{{ env('APP_URL') . asset('admin_files') }}/js/todolist.js"></script>
@endpush
