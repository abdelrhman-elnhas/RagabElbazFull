      ...
      >
        ...
        >
          <ul class="cards">
            <li>
              <div class="card">
                <img src="./{{asset('web_files')}}/images/service1.jpg" class="card__image" alt="" />
            ...
            <li>
              <div class="card">
                <img src="./{{asset('web_files')}}/images/service4.jpg" class="card__image" alt="" />
                <div class="card__overlay">
                  <div class="card__header">
                    <svg class="card__arc" xmlns="http://www.w3.org/2000/svg">
                      <path />
            ...
            <li>
              <div class="card">
                <img src="./{{asset('web_files')}}/images/service3.jpg" class="card__image" alt="" />
                <div class="card__overlay">
                  <div class="card__header">
                    <svg class="card__arc" xmlns="http://www.w3.org/2000/svg">
                      <path />
            ...
            <li>
              <div class="card">
                <img src="./{{asset('web_files')}}/images/service5.jpg" class="card__image" alt="" />
                <div class="card__overlay">
                  <div class="card__header">
                    <svg class="card__arc" xmlns="http://www.w3.org/2000/svg">
                      <path />
            ...
            <li>
              <div class="card">
                <img src="./{{asset('web_files')}}/images/service2.jpg" class="card__image" alt="" />
                <div class="card__overlay">
                  <div class="card__header">
                    <svg class="card__arc" xmlns="http://www.w3.org/2000/svg">
                      <path />
											...
											<div class="col-md-4 p-2">
													<div class="tour-item ">
															<div class="tour-desc bg-white">
																	...
																	<div class="d-flex justify-content-center pt-2 pb-2"><img class="tm-people" src="./{{asset('web_files')}}/images/avatar.png" alt=""></div>
          ...
          <div class="text-center text-md-end mt-5">
            <div class="row mt-3">
              ...
              <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 pt-4">
                <img
                  src="./{{asset('web_files')}}/images/logoWhite.png"
                  class="img-fluid"
                  alt="Altafawouk Logo"
                />
              </div>
