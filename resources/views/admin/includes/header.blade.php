<div class="container-scroller">
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center pr-5 pr-md-0">
            <img src="{{ env('APP_URL') . asset('admin_files') }}/favicon.png" alt="profile" width="60">
        </div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="#"
                        ...
                        <span class="count-symbol"
                            style="border: none;top: 12px;right: 20px;width: 24px;height: 24px;">{{ adminNotificationsCount() }}</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                        ...
                        @forelse (adminNotifications() as $n)
                            <a href="{{ aurl('members/show2') . '/' . $n->user->id }}"
    ...
    <div class="container-fluid page-body-wrapper pr-0 pl-0">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic" style="">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"> <a class="nav-link" href="{{ aurl('members/old') }}">اعضاء مفعلين</a>
                            </li>
                            <li class="nav-item"> <a class="nav-link" href="{{ aurl('members/new') }}">اعضاء في
                                    الانتظار</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{ aurl('members/tops') }}">اعضاء
                                    متفوقين</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item ">
                    <a class="nav-link " data-toggle="collapse " href="{{ url('') }}" aria-expanded="false "
